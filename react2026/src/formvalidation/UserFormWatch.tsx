...
export const UserFormWatch = () => {
    const form = useForm<UserFormValues>();
    // watch
    const {register , control , handleSubmit , formState ,  watch} = form;

    const watchUserName = watch("username");
    const watchFullForm = watch(); 
    // With watch componenent render every time when use it so useeffect
    ...
    return (
        ...
        <h2>watch:fullform {JSON.stringify(watchFullForm)}</h2>
